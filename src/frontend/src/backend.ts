...
export class Backend implements backendInterface {
    ...
    async addAffiliateProduct(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addAffiliateProduct(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAffiliateProduct(arg0: bigint): Promise<AffiliateProduct> {
        if (this.processError) {
            try {
                const result = await this.actor.getAffiliateProduct(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllAffiliateProducts(): Promise<Array<AffiliateProduct>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllAffiliateProducts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllFeedbackEntries(): Promise<Array<Feedback>> {
        if (this.processError) {
            try {
